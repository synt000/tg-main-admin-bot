...
def build_enterprise_schema():
    ...
    queries = [
        ...
        "CREATE TABLE IF NOT EXISTS customers (customer_id SERIAL PRIMARY KEY, business_id VARCHAR(50), name VARCHAR(100), phone VARCHAR(30) UNIQUE, total_spent NUMERIC DEFAULT 0, loyalty_points INT DEFAULT 0, created_at TIMESTAMP DEFAULT NOW());",
...
if __name__ == "__main__": build_enterprise_schema()
